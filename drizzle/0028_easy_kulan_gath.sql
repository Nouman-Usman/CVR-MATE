...
-- RLS parity (mirrors 0025_enable_rls_public_tables). The app connects as the
-- table owner via a direct pg Pool, which bypasses RLS — no policies needed;
-- this only keeps the Supabase rls_disabled linter satisfied on the CRM tables.
