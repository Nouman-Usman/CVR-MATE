  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        contactWww: state.contactWww,
        size: state.size,
        employmentAmount: state.employmentAmount,
        companyformCode: state.companyformCode,
        companyformDescription: state.companyformDescription,
        companyformHolding: state.companyformHolding,
        companystatusCode: state.companystatusCode,
        statusBankrupt: state.statusBankrupt,
        capitalCapital: state.capitalCapital,
        capitalCurrency: state.capitalCurrency,
        capitalIpo: state.capitalIpo,
        infoEanId: state.infoEanId,
        infoLeiId: state.infoLeiId,
        ...
        skipMarketingOptOut: state.skipMarketingOptOut,
